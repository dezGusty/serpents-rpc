...
public:
	...
	{
		XMLParser = serpents::util::xml::XMLFactory::getXMLParser();
	...
	void handle_handshake(const boost::system::error_code& error)
	{
		if (!error)
		{
			std::string replyString = XMLParser->generateXMLDoc(*requestParameters_);
...
private:
	serpents::util::xml::IXMLClass* XMLParser;
